...
const categories = [
  {
    ...
    chipColor: "bg-secondary-container text-on-secondary-container",
    order: 1,
  },
  {
    id: "mercearia",
    ...
    nameEn: "Groceries",
    icon: "grocery",
    chipColor: "bg-tertiary-container text-on-tertiary-container",
    order: 2,
  },
  {
    id: "gerais",
    ...
    icon: "inventory_2",
    chipColor: "bg-surface-container-high text-on-surface",
    order: 3,
  },
  {
    id: "promocoes",
...
const products = [
  {
    ...
    price: 450,
    currency: "MT",
    imageUrl: "",  // Add Firebase Storage URL after uploading images
    inStock: true,
    featured: true,
  },
  {
    name: "Detergente Roupa 2L",
    nameEn: "Laundry Detergent 2L",
    category: "limpeza",
    price: 280,
    currency: "MT",
    imageUrl: "",
  ...
  {
    name: "Desinfetante Multiusos 500ml",
    nameEn: "Multi-purpose Disinfectant 500ml",
    category: "limpeza",
    price: 120,
    currency: "MT",
    imageUrl: "",
...
async function seed() {
  ...
  categories.forEach((cat) => {
    const { id, ...data } = cat;
    catBatch.set(db.collection("categories").doc(id), {
      ...data,
