    ...
    <div className="min-h-screen pb-24 md:pb-0">
      ...
      >
        <div className="max-w-xl mx-auto">
          <span
            className="material-symbols-outlined text-[48px] text-primary mb-3 block"
          ...
          <p className="font-body text-body-md text-on-surface-variant mt-2">{STORE_INFO.address}</p>
        </div>
      </section>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-margin-desktop py-8 space-y-10">
        ...
        <Reveal animation="fade-up">
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-card border border-outline-variant relative">
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            <Reveal animation="fade-up" delay="0ms">
          ...
          {/* Right — contact form */}
          <Reveal animation="fade-up" delay="100ms">
            <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant p-6 md:p-8 shadow-card">
              ...
              {sent ? (
                <div className="flex flex-col items-center gap-4 py-8 text-center">
                  <span className="material-symbols-outlined text-[56px] text-secondary" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input name="name" value={form.name} onChange={handleChange} required
                      placeholder={lang === "pt" ? "O seu nome" : "Your name"} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>Email *</label>
                    <input name="email" type="email" value={form.email} onChange={handleChange} required
                      placeholder={lang === "pt" ? "o.seu@email.com" : "your@email.com"} className={inputClass} />
                  </div>
                  <div>
